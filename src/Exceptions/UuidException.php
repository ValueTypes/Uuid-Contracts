...
namespace ValueTypes\UuidContracts\Exceptions;

/**
 * Represents any Exception thrown by implementations of these contracts.
 *
 * Interface UuidException
 * @package ValueTypes\UuidContracts\Exceptions
 */
interface UuidException {}